...
///[String] method [arabicDay]
///takes the variable day
///and return [String] value DayName
String arabicDay(var day) {
  switch (day) {
    case 6:
    case "Saturday":
      return "السبت";
...
///[String] method [englishDay]
///takes the variable day
///and return [String] value DayName
String englishDay(var day) {
  switch (day) {
    case 6:
      return "Saturday";
    case 0:
  ...
  String _fullDate() {
    switch (fDisplay) {
      case DisplayFormat.MMDD:
        return "$month-$day";
      case DisplayFormat.DDMM:
        return "$day-$month";
      case DisplayFormat.MMMDD:
        return "$monthName-$day";
      case DisplayFormat.DDMMM:
        return "$day-$monthName";
      case DisplayFormat.DDDMMM:
        return "$dayName-$day-$monthName";
      case DisplayFormat.MMMDDD:
        return "$monthName-$day-$dayName";
      case DisplayFormat.DDDMMMYYYY:
        return "$dayName-$day-$monthName-$year";
      case DisplayFormat.MMMDDDYYYY:
        return "$monthName-$day-$dayName-$year";
      case DisplayFormat.MMDDYYYY:
      ...
      case DisplayFormat.MMMDDYYYY:
        return "$monthName-$day-$year";
      case DisplayFormat.DDMMMYYYY:
      default:
        return "$day-$month-$year";
    }
  }
...
class HijriDate {
  ...
  HijriDate.dateToHijri(DateTime jDD) {
    ...
    _jWesternDate = InternalConverter(
      ...
      fMonth: jDD.month,
      fYear: jDD.year,
      fWeekday: jDD.weekday,
      fDayName: englishDay(jDD.weekday),
